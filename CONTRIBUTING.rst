...
Welcome to ``rclonerc`` contributor's guide.
...
If you experience bugs or general issues with ``rclonerc``, please have a look
...
You can help improve ``rclonerc`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``rclonerc`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``rclonerc``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n rclonerc python=3 six virtualenv pytest pytest-cov
    conda activate rclonerc
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/rclonerc.git
    cd rclonerc
...
#. Install |pre-commit|_::
   ...
   ``rclonerc`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/rclonerc
.. _issue tracker: https://github.com/<USERNAME>/rclonerc/issues
.. <-- end -->
